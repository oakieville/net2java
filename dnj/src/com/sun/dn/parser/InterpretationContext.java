...
import com.sun.dn.library.LibraryData;
	...
	/** InterpretationContexts are structures in .NET code in which
	** statements (and expressions) can execute. An example
	** of an interpretation contexts is a subroutine.
