/*
 * $Id: HtmlMessage.java,v 1.1 2007/01/05 01:23:01 dannyc Exp $
 */
...
/**
 * <p>By default, the <code>rendererType</code> property must be set to "<code>javax.faces.Message</code>" This value can be changed by calling the <code>setRendererType()</code> method.</p>
*/
public class HtmlMessage extends javax.faces.component.UIMessage {
  ...
  public Object saveState(FacesContext _context) {
    ...
    _values[6] = infoStyle;
    _values[7] = style;
    _values[8] = styleClass;
    _values[9] = title;
    _values[10] = this.tooltip ? Boolean.TRUE : Boolean.FALSE;
    _values[11] = this.tooltip_set ? Boolean.TRUE : Boolean.FALSE;
    _values[12] = warnClass;
    _values[13] = warnStyle;
    return _values;
  }
  ...
  public void restoreState(FacesContext _context, Object _state) {
    ...
    this.style = (java.lang.String) _values[7];
    this.styleClass = (java.lang.String) _values[8];
    this.title = (java.lang.String) _values[9];
    this.tooltip = ((Boolean) _values[10]).booleanValue();
    this.tooltip_set = ((Boolean) _values[11]).booleanValue();
    this.warnClass = (java.lang.String) _values[12];
    this.warnStyle = (java.lang.String) _values[13];
  }
