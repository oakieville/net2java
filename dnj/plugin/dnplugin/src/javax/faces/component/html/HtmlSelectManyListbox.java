/*
 * $Id: HtmlSelectManyListbox.java,v 1.1 2007/01/05 01:23:03 dannyc Exp $
 */
 ...
 * <p>By default, the <code>rendererType</code> property must be set to "<code>javax.faces.Listbox</code>" This value can be changed by calling the <code>setRendererType()</code> method.</p>
*/
public class HtmlSelectManyListbox extends javax.faces.component.UISelectMany {
  ...
  public Object saveState(FacesContext _context) {
    ...
    _values[24] = new Integer(this.size);
    _values[25] = this.size_set ? Boolean.TRUE : Boolean.FALSE;
    _values[26] = style;
  ...
  public void restoreState(FacesContext _context, Object _state) {
    ...
    this.size = ((Integer) _values[24]).intValue();
    this.size_set = ((Boolean) _values[25]).booleanValue();
