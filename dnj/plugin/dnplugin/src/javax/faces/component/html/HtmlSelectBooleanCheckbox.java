/*
 * $Id: HtmlSelectBooleanCheckbox.java,v 1.1 2007/01/05 01:23:03 dannyc Exp $
 */
 ...
 * <p>By default, the <code>rendererType</code> property must be set to "<code>javax.faces.Checkbox</code>" This value can be changed by calling the <code>setRendererType()</code> method.</p>
*/
public class HtmlSelectBooleanCheckbox extends javax.faces.component.UISelectBoolean {
  ...
  public Object saveState(FacesContext _context) {
    ...
    _values[19] = onselect;
    _values[20] = this.readonly ? Boolean.TRUE : Boolean.FALSE;
    _values[21] = this.readonly_set ? Boolean.TRUE : Boolean.FALSE;
    _values[22] = style;
  ...
  public void restoreState(FacesContext _context, Object _state) {
    ...
    this.readonly = ((Boolean) _values[20]).booleanValue();
    this.readonly_set = ((Boolean) _values[21]).booleanValue();
    ...
    this.title = (java.lang.String) _values[25];
  }
