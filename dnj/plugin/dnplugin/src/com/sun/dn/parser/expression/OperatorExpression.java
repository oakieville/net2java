...
import com.sun.dn.parser.InterpretationContext;
	...
	/** A .NET expression that uses an operator to modify an expression
	** or combine expressions. Defined as <br>
	OperatorExpression ::= UnaryOperatorExpression | BinaryOperatorExpression <br> <br>
...
public abstract class OperatorExpression extends ExpressionAdapter {
    
    protected OperatorExpression(String code, InterpretationContext context) {
        super(code, context);
    }
