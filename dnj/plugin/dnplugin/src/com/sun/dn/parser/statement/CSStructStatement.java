...
public class CSStructStatement extends CSMetaClass {
        

	public CSStructStatement(String code, InterpretationContext context) {
		super(code, context);
	}
        
        protected String myKeyword() {
            return CSKeywords.CS_Struct;
        }
	...
	public static boolean isCSStructStatement(String code, InterpretationContext context) {
		if (code.indexOf("{") != -1) {
			String potentialDeclaration = Util.getUpToOpeningCurlyBracket(code.trim());
			List l = getDeclarationAsTokens(potentialDeclaration);
			return l.contains(CSKeywords.CS_Struct);
		}
		return false;
	}
