/*
 * $Id: HtmlInputTextarea.java,v 1.1 2007/01/05 01:23:01 dannyc Exp $
 */
 ...
 * <p>By default, the <code>rendererType</code> property must be set to "<code>javax.faces.Textarea</code>" This value can be changed by calling the <code>setRendererType()</code> method.</p>
*/
public class HtmlInputTextarea extends javax.faces.component.UIInput {
  ...
  /**
   * <p>Return the value of the <code>cols</code> property.  Contents:</p><p>
  ...
  /**
   * <p>Return the value of the <code>rows</code> property.  Contents:</p><p>
  ...
  public Object saveState(FacesContext _context) {
    ...
    _values[1] = accesskey;
    _values[2] = new Integer(this.cols);
    _values[3] = this.cols_set ? Boolean.TRUE : Boolean.FALSE;
    _values[4] = dir;
  ...
  public void restoreState(FacesContext _context, Object _state) {
    ...
    this.cols = ((Integer) _values[2]).intValue();
    this.cols_set = ((Boolean) _values[3]).booleanValue();
